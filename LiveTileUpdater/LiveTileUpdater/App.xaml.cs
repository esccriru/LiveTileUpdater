...
using LiveTileUpdater.Services;
...
namespace LiveTileUpdater
{
    public partial class App : Application
    {
        ...
        private static AplicationLiveTileUpdater aplicationLiveTileUpdater;

        internal static AplicationLiveTileUpdater AplicationLiveTileUpdater
        {
            get 
            {
                if (aplicationLiveTileUpdater == null)
                {
                    aplicationLiveTileUpdater = new AplicationLiveTileUpdater();
                }
                return aplicationLiveTileUpdater; 
            }
            set { aplicationLiveTileUpdater = value; }
        }
